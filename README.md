Alina is a hassle free voice assistant with command line interface/terminal coded in python with a registration page using PHP and web development to keep a track of the users.
